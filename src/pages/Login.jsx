...
const Login = () => {
  ...
  const handleTelegramLogin = () => {
    ...
    window.location.href = `https://oauth.telegram.org/auth?bot_id=${botId}&origin=${origin}&request_access=write&embed=1&bot_username=${botUsername}`;
  };
  ...
  const handleManualTelegramLogin = () => {
    ...
    localStorage.setItem("telegram_login_id", loginId.toString());
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        ...
        <div className="relative flex items-center justify-center p-8 lg:p-12 border-b lg:border-b-0 lg:border-r border-neutral-900">
          ...
          <div className="relative w-full max-w-xl aspect-square rounded-3xl bg-neutral-900/70 border border-neutral-800 shadow-2xl overflow-hidden">
            {/* put your <img src="/logo.png" /> here if you have a logo */}
        ...
        <div className="flex items-center justify-center p-6 md:p-10">
          <div className="w-full max-w-md">
            <div className="mb-8">
              ...
              <p className="mt-2 text-neutral-400">Enter to your account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 rounded-xl bg-neutral-100 text-neutral-900 font-medium hover:bg-white transition active:scale-[.99] disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {isLoading ? (
            ...
            <button
              ...
              className="w-full h-12 rounded-xl bg-neutral-800 text-neutral-200 hover:bg-neutral-700 transition inline-flex items-center justify-center gap-2"
            >
